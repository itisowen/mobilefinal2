...
class FriendScreen extends State<FriendPage> {
              ...
              switch (snapshot.connectionState) {
                ...
                default:
                  if (snapshot.hasError) {
                    ...
                    return MyFriendList(context, snapshot);
                  }
              }
            },
          )
  ...
  Widget MyFriendList(BuildContext context, AsyncSnapshot snapshot) {
            ...
            child: new InkWell(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(padding: EdgeInsets.fromLTRB(0, 16, 0, 12)),
                  Text(
                    values[index].email,
